...
namespace CompetitionAnalysis.Persistance.Migrations.AppDb
{
    /// <inheritdoc />
    public partial class CodeFirts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "02188350-e299-442d-8620-d17bbf855fdb", new DateTime(2024, 2, 14, 4, 45, 5, 496, DateTimeKind.Local).AddTicks(1937), null, false, false, false, "ADMIN", null },
                    { "5e9915cc-bc27-4e26-8684-0a0e38a7c801", new DateTime(2024, 2, 14, 4, 45, 5, 496, DateTimeKind.Local).AddTicks(1946), null, false, false, false, "EDITOR", null },
                    { "f42c9b68-7ea3-4812-8697-1c8667e29e31", new DateTime(2024, 2, 14, 4, 45, 5, 496, DateTimeKind.Local).AddTicks(1947), null, false, false, false, "USER", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "45d7be85-af9e-4241-8933-e7e5a5020849", 0, "35389933-9743-46c6-83b0-cbc4e0b4f898", "onurumutluoglu@gmail.com", false, "Onur", "UMUTLUOGLU", false, null, "Onur UMUTLUOGLU", "ONURUMUTLUOGLU@GMAIL.COM", "ONUR", "AQAAAAIAAYagAAAAEDEtGUt+pTdcsr7fWnH/wZ8lCAdhyveRfEU5RAjsvrDjQENcGESkOqAwyVx7RqrTbw==", null, false, "9fb0ba42-b40f-4b8f-84b3-0484f87c94de", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "UGM43S2UTDAM4GLLRJERICUKWLE7MEYD", false, "onur" });

            migrationBuilder.InsertData(
                table: "MainRoleAndUserRelationships",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "IsActive", "IsDelete", "MainRoleId", "UpdatedDate", "UserId" },
                values: new object[] { "990d8fe5-6805-4805-bfcb-a4f4a5e18871", new DateTime(2024, 2, 14, 4, 45, 5, 496, DateTimeKind.Local).AddTicks(1962), null, false, false, "02188350-e299-442d-8620-d17bbf855fdb", null, "45d7be85-af9e-4241-8933-e7e5a5020849" });
