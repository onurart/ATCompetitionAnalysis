...
{
    public class ProductCustomerRelationshipsQueryRepository: CompanyDbQueryRepository<ProductCustomerRelationshipses>,IProductCustomerRelationshipQueryRepository
    {
    }
}
